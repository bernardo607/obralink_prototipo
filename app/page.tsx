      ...
      <header className="bg-[#1A3D7C] text-white py-10 px-6">
        <div className="max-w-6xl mx-auto flex flex-col items-center text-center">
          ...
          <p className="text-xl mt-4 max-w-2xl">
            La plataforma digital que transforma la gestión de obras para arquitectos,
            ...
            {[
              {
                ...
                desc: "Controlá gastos, ingresos y flujo de fondos con reportes automáticos."
              },
              {
                title: "Inventarios y Pedidos",
                desc: "Monitoreá tu stock y los pedidos a proveedores en tiempo real."
              },
              {
                title: "Planos y Documentación",
                desc: "Centralizá planos, permisos y documentos críticos en un solo lugar."
              },
              {
                title: "Comunicación",
                desc: "Unificá mensajes entre cliente, arquitecto y contratistas."
              },
            ].map(({ title, desc }, i) => (
